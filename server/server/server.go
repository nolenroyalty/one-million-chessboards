...
const (
	SOFT_MAX_CONNECTIONS_PER_IP   = 50 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
	...
	MAX_CONS_PER_SECOND_IPV4   = 5 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
	MAX_CONS_PER_SECOND_IPV6   = 4 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
	BURST_CONS_PER_SECOND_IPV4 = 10 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
