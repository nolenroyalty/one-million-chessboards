...
const (
	...
	MAX_SNAPSHOTS_PER_SECOND_SOFT = 1 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
	SNAPSHOT_BURST_LIMIT_SOFT     = 3 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT

	MAX_MOVES_PER_SECOND      = 2 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
	MOVE_BURST_LIMIT          = 4 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
	MAX_MOVES_PER_SECOND_SOFT = 1 * TESTING_MULTIPLIER_CHANGE_YOU_LITTLE_SHIT
